                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.kabkota.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Kab/Kota">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="provinsi_id" class="form-control" id="provinsi_id" placeholder="Provinsi ID">
                                    </div>
